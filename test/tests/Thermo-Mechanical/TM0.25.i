# conda activate moose && mpirun -n 8 /home/yp/projects/annular_pellet/annular_pellet-opt -i TM0.25.i
initial_T = 558.2
initial_T_in = 570.7
initial_T_out = 582.8
pellet_nu = 0.345
...
n_azimuthal = '${fparse int(3.1415*(pellet_outer_diameter)/4/mesh_size*1e-3/2^(w-2))}' #int()取整
...
[Mesh]
  ...
  [rename]
    ...
    new_boundary = 'pellet_inner pellet_outer x_axis y_axis'
  []
  [rename2]
