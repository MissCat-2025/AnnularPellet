# conda activate moose && mpirun -n 8 /home/yp/projects/annular_pellet/annular_pellet-opt -i mesh0.5.i --mesh-only
...
n_azimuthal = '${fparse int(3.1415*(pellet_outer_diameter)/2/mesh_size*1e-3/2^(w-2))}' #int()取整
